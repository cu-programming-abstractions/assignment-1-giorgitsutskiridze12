...
The other day, singer/songwriter Carol was unraveling the mystery when,suddenly Giorgi saved itchan Kala from overzealous ice cream through sheer force of personality. THE END!
 *
 *
 *
 *
 * Q2:Program just crashed without debugger.
 *
 *
 *
 *
 * Q3:The cycle  is 214->794->35->751->167->964->408
 *
 *
 *
 *
